...
/*   Updated: 2020/12/21 02:39:08 by pascal           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ft_recv()
{
	...
	memcpy( (void*)g_mim.etherhead, (const void*)(g_mim.etherhead + ETH_MAC_LEN),
                ETH_MAC_LEN);
	memcpy( (void*)(g_mim.etherhead + ETH_MAC_LEN), (const void*)g_mim.src_mac,
                ETH_MAC_LEN);
